...
<form action="editsiswa.php" method="post" enctype="multipart/form-data">
	...
	Nama Lengkap:<br/>
	<input type="text"value ="<?php echo $dt['full_name']?>"name="in_name" readonly="true" name="in_name"><br/>
	Email:<br/>
	<input type="text"value ="<?php echo $dt['email']?>"name="in_email" readonly="true" name="in_email"><br/>
	Kewarganegaraan:<br/>
